...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \textcolor{keyword}{struct\ }\_interpreter\ \{}
...
\DoxyCodeLine{00118\ }
\DoxyCodeLine{00119\ \ \ \ \ \textcolor{keyword}{static}\ \_interpreter\&\ get()\ \{}
\DoxyCodeLine{00120\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ interkeeper(\textcolor{keyword}{false});}
\DoxyCodeLine{00121\ \ \ \ \ \}}
\DoxyCodeLine{00122\ }
\DoxyCodeLine{00123\ \ \ \ \ \textcolor{keyword}{static}\ \_interpreter\&\ kill()\ \{}
...
\DoxyCodeLine{00128\ \ \ \ \ \textcolor{keyword}{static}\ \_interpreter\&\ interkeeper(\textcolor{keywordtype}{bool}\ should\_kill)\ \{}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \textcolor{keyword}{static}\ \_interpreter\ ctx;}
...
\DoxyCodeLine{00165\ }
\DoxyCodeLine{00166\ \ \ \ \ \_interpreter()\ \{}
\DoxyCodeLine{00167\ }
...
\DoxyCodeLine{00285\ \ \ \ \ \}}
\DoxyCodeLine{00286\ }
\DoxyCodeLine{00287\ \ \ \ \ \string~\_interpreter()\ \{}
...
\DoxyCodeLine{00353\ \textcolor{comment}{//static\_assert(sizeof(long\ long)\ ==\ 8);}}
\DoxyCodeLine{00354\ \textcolor{comment}{//template\ <>\ struct\ select\_npy\_type<long\ long>\ \{\ const\ static\ NPY\_TYPES\ type\ =\ NPY\_INT64;\ \};}}
\DoxyCodeLine{00355\ \textcolor{comment}{//(sizeof(unsigned\ long\ long)\ ==\ 8);}}
\DoxyCodeLine{00356\ \textcolor{comment}{//template\ <>\ struct\ select\_npy\_type<unsigned\ long\ long>\ \{\ const\ static\ NPY\_TYPES\ type\ =\ NPY\_UINT64;\ \};}}
\DoxyCodeLine{00357\ }
...
\DoxyCodeLine{00362\ \ \ \ \ NPY\_TYPES\ \mbox{\hyperlink{structmatplotlibcpp_1_1detail_1_1is__callable__impl}{type}}\ =\ select\_npy\_type<Numeric>::type;}
\DoxyCodeLine{00363\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{structmatplotlibcpp_1_1detail_1_1is__callable__impl}{type}}\ ==\ NPY\_NOTYPE)\ \{}
...
\DoxyCodeLine{00917\ }
\DoxyCodeLine{00918\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ imshow(\textcolor{keywordtype}{void}\ *ptr,\ \textcolor{keyword}{const}\ NPY\_TYPES\ \mbox{\hyperlink{structmatplotlibcpp_1_1detail_1_1is__callable__impl}{type}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ rows,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ columns,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ colors,\ \textcolor{keyword}{const}\ std::map<std::string,\ std::string>\ \&keywords,\ PyObject**\ out)}
\DoxyCodeLine{00919\ \{}
\DoxyCodeLine{00920\ \ \ \ \ assert(\mbox{\hyperlink{structmatplotlibcpp_1_1detail_1_1is__callable__impl}{type}}\ ==\ NPY\_UINT8\ ||\ \mbox{\hyperlink{structmatplotlibcpp_1_1detail_1_1is__callable__impl}{type}}\ ==\ NPY\_FLOAT);}
...
\DoxyCodeLine{00928\ \ \ \ \ PyTuple\_SetItem(args,\ 0,\ PyArray\_SimpleNewFromData(colors\ ==\ 1\ ?\ 2\ :\ 3,\ dims,\ \mbox{\hyperlink{structmatplotlibcpp_1_1detail_1_1is__callable__impl}{type}},\ ptr));}
\DoxyCodeLine{00929\ }
...
\DoxyCodeLine{02887\ \textcolor{keyword}{class\ }Plot}
\DoxyCodeLine{02888\ \{}
...
\DoxyCodeLine{02892\ \ \ \ \ Plot(\textcolor{keyword}{const}\ std::string\&\ name,\ \textcolor{keyword}{const}\ std::vector<Numeric>\&\ x,\ \textcolor{keyword}{const}\ std::vector<Numeric>\&\ y,\ \textcolor{keyword}{const}\ std::string\&\ format\ =\ \textcolor{stringliteral}{"{}"{}})\ \{}
...
\DoxyCodeLine{02930\ \ \ \ \ Plot(\textcolor{keyword}{const}\ std::string\&\ name\ =\ \textcolor{stringliteral}{"{}"{}},\ \textcolor{keyword}{const}\ std::string\&\ format\ =\ \textcolor{stringliteral}{"{}"{}})}
\DoxyCodeLine{02931\ \ \ \ \ \ \ \ \ :\ Plot(name,\ std::vector<double>(),\ std::vector<double>(),\ format)\ \{\}}
\DoxyCodeLine{02932\ }
...
\DoxyCodeLine{02967\ \ \ \ \ \}}
\DoxyCodeLine{02968\ }
\DoxyCodeLine{02969\ \ \ \ \ \string~Plot()\ \{}
